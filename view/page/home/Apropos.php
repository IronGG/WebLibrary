...
<div class="container mt-5">
    <div class="mb-5">
        <h2>Le projet</h2>
        <p>
        Ce site a été réalise dans le cadre d'un projet web dynamique avec du php/mysql/html/css en utilisant des outils tels que des frameworks (Bootstrap dans notre cas).
